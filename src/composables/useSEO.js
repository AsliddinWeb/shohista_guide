...
const PAGES = {
  ...
  tours: {
    ru: {
      title: 'Туры по Самарканду — 14 маршрутов | Shohista Guide',
    ...
    en: {
      title: 'Samarkand Tours & Excursions — 14 Destinations | Shohista Guide',
    ...
    uz: {
      title: 'Samarqand turlari — 14 yo\'nalish | Shohista Guide',
    ...
    tr: {
      title: 'Semerkand Turları — 14 Güzergah | Shohista Guide',
  ...
  gallery: {
    ru: {
      title: 'Фото Самарканда — Галерея туров | Shohista Guide',
    ...
    en: {
      title: 'Samarkand Photo Gallery — Tour Moments | Shohista Guide',
    ...
    uz: {
      title: 'Samarqand fotogalereyasi — Tur lahzalari | Shohista Guide',
    ...
    tr: {
      title: 'Semerkand Fotoğraf Galerisi — Tur Anları | Shohista Guide',
  ...
  contact: {
    ru: {
      title: 'Забронировать тур по Самарканду | Shohista Guide — Контакты',
    ...
    en: {
      title: 'Book a Samarkand Tour | Shohista Guide — Contact',
    ...
    uz: {
      title: 'Samarqandda tur bron qilish | Shohista Guide — Aloqa',
    ...
    tr: {
      title: 'Semerkand Turu Rezervasyonu | Shohista Guide — İletişim',
...
export function useSEO({ page = 'home', locale, image, url }) {
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:image:alt',          content: 'Shohista Guide — Samarkand Tour Guide' },
      { property: 'og:url',                content: canonicalUrl },
      { property: 'og:type',               content: 'website' },
      { property: 'og:site_name',          content: 'Shohista Guide' },
      ...
      { name: 'twitter:image:alt',   content: 'Shohista Guide Samarkand' },
    ],
    link: [
