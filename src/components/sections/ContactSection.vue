...
const tourOptions = [
  'Ансамбль Регистан — от $30',
  'Шахи-Зинда — от $25',
  'Мечеть Биби-Ханым — от $20',
  'Мавзолей Гур-Эмир — от $20',
  'Музей Афрасиаб — от $25',
  'Шахрисабз (Ак-Сарай) — от $45',
  'Мастер-класс: Плов',
          ...
          <div class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input v-model="formData.phone" type="tel" placeholder="+998 88 395 41 41" :class="inputClass(false)" />
              </div>
            </div>
